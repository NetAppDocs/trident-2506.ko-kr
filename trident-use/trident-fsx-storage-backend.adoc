...
| `luksEncryption` | LUKS 암호화를 활성화합니다. link:../trident-reco/security-luks.html["Linux Unified Key Setup(LUKS) 사용"]을(를) 참조하십시오. SAN 전용입니다. | "" 
