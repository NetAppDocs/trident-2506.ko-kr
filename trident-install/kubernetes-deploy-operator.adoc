...
이제  `TridentOrchestrator`를 생성하고 Trident를 설치할 수 있습니다. 선택적으로, link:../trident-install/kubernetes-customize-deploy.html["Trident 설치를 사용자 정의하세요"]를  `TridentOrchestrator` 사양의 속성을 사용하여 수행할 수 있습니다.
