...
* Trident를 https://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Files"] 사용할 때 발생할 수 있는 일반적인 문제는 테넌트 및 클라이언트 암호가 권한이 부족한 앱 등록에서 제공되는 경우입니다. Trident 요구 사항의 전체 목록은 link:trident-use/anf.html["Azure NetApp Files"] 구성을 참조하십시오.
