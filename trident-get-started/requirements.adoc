...
* NetApp 전체 또는 제한적 지원을 받는 ONTAP 버전을 실행하는 온프레미스 FAS, AFF 또는 ASA r2(iSCSI, NVMe/TCP 및 FC). link:https://mysupport.netapp.com/site/info/version-support["소프트웨어 버전 지원"]을(를) 참조하십시오.
