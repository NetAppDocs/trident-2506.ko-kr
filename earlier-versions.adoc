...
summary: 버전 선택기를 사용하여 최신 버전과 이전 4개 버전 사이를 탐색하거나 아래 링크를 사용할 수 있습니다. 
---
= 이전 버전의 문서
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Trident 25.06을 실행하지 않는 경우 이전 릴리스에 대한 설명서를 사용할 수 있습니다.link:get-help.html["Trident 지원 수명주기"] .
