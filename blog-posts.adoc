...
summary: 훌륭한 NetApp Trident 와 Trident Protect 블로그를 찾아볼 수 있습니다. 
---
= Trident 와 Trident 블로그를 보호합니다
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
NetApp Trident 와 Trident Protect에 대한 훌륭한 블로그는 다음에서 찾을 수 있습니다.
...
* 2024년 11월 11일: https://community.netapp.com/t5/Tech-ONTAP-Blogs/Introducing-tridentctl-protect-the-powerful-CLI-for-Trident-protect/ba-p/456494["tridentctl protect 소개: Trident protect를 위한 강력한 CLI"^]
